  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="relative flex h-[70vh] w-full flex-col items-center justify-center bg-white bg-grid-black/[0.2] dark:bg-background dark:bg-grid-white/[0.2]">
        ...
        <h1 className="relative z-20 bg-gradient-to-b from-blue-100 to-indigo-700 bg-clip-text py-8 text-4xl font-bold text-transparent sm:text-7xl">
          Harith Iqbal
        </h1>
        <h4>
          software engineer who program for a living and as hobby for my free
          time
        </h4>
        <h4>
          playing video games, building computer and photography are some of the
          things that I enjoyed
        </h4>
        <h4>
          started programming during my enrollment in university and started my
          career as a <i>Software Engineer</i> since 2022
        </h4>
      </div>
      <InfiniteScroll />
